-- Corrección: Evitar incremento de clases mensuales cuando la cancelación falla por límite de tiempo
...
BEGIN
  ...
  -- CRÍTICO: Si falla la validación, retornar SIN modificar NADA
  ...
  -- SOLO si llegamos aquí: ejecutar cancelación
  ...
  -- Devolver clase al usuario SOLO si la cancelación fue exitosa
